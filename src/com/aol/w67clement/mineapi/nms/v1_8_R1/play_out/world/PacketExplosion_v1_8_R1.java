 ...
 * 
 * @author 67clement
 * @version 1.2 - CraftBukkit 1.8 SNAPSHOT
 */
public class PacketExplosion_v1_8_R1 implements PacketExplosion {
	...
	public PacketExplosion_v1_8_R1(World world, double x, double y, double z, float radius) {
		this.x = x;
		this.y = y;
		this.z = z;
		this.radius = radius;
	...
	public PacketExplosion_v1_8_R1(Location location, float radius) {
	...
	public PacketExplosion_v1_8_R1(Location location, float radius, boolean sound) {
		this.x = location.getX();
		this.y = location.getY();
		this.z = location.getZ();
		this.radius = radius;
	...
	public String toString() {
		return "Explosion[World:" + this.getWorldName() + ",X:" + this.x
				+ ",Y:" + this.y + ",Z:" + this.z + ",Radius:" + this.radius
				+ ",Sound:" + this.sound + "]";
	}
