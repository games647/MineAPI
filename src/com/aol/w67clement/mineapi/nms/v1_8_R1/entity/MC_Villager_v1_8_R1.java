...
public class MC_Villager_v1_8_R1 extends MC_EntityAgeable_v1_8_R1 implements
		MC_Villager {
	...
	public void addMerchantRecipe(MC_MerchantRecipe recipe) {
		Field field = ReflectionAPI.getField(this.villager.getClass(), "bp",
				true);
	...
	public List<MC_MerchantRecipe> getMerchantRecipeList() {
		...
		MerchantRecipeList nms_recipes = (MerchantRecipeList) ReflectionAPI
				.getValue(this.villager, ReflectionAPI.getField(this.villager.getClass(), "bp",
						true));
	...
	public MC_MerchantRecipe getMerchantRecipe(int index) {
		try {
			return new MC_MerchantRecipe(((MerchantRecipeList) ReflectionAPI
					.getValue(this.villager, ReflectionAPI.getField(this.villager.getClass(), "bp",
							true))).get(index));
		} catch (Exception e) {
			e.printStackTrace();
