 ...
 * 
 */
public class PacketBlockBreakAnimation_v1_8_R3 implements
	...
	public PacketBlockBreakAnimation_v1_8_R3(MC_Player player,
	...
	public PacketBlockBreakAnimation_v1_8_R3(MC_Player player, int x, int y,
			int z, byte destroyStage) {
		this(player, new Location(Bukkit.getWorlds().get(0), x, y, z),
				destroyStage);
	}

	public PacketBlockBreakAnimation_v1_8_R3(Player player,
			Location blockLocation, byte destroyStage) {
		this(MineAPI.getNmsManager().getMCPlayer(player), blockLocation,
				destroyStage);
	}

	public PacketBlockBreakAnimation_v1_8_R3(Player player, int x, int y,
			int z, byte destroyStage) {
