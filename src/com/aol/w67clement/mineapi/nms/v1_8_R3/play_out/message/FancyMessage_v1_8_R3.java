...
public class FancyMessage_v1_8_R3 implements FancyMessage {

	private List<MessagePart> messageParts;

	public FancyMessage_v1_8_R3(String string) {
	...
	public void send(Player player) {
		((CraftPlayer) player).getHandle().playerConnection
				.sendPacket(new PacketPlayOutChat(IChatBaseComponent.ChatSerializer.a(this
						.toJSONString())));
	}
