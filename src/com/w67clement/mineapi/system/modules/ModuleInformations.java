...
public class ModuleInformations
{
	...
	public ModuleInformations(String name, String main, String description,
			String version, String authors, String website) {
		this.name = name;
		this.main = main;
	...
	private void loadMap(Map<?, ?> map) throws InvalidDescriptionException
	{
		try
		{
			...
			if (!this.name.matches(
					"^[A-Za-z0-9 _.-]+$")) { throw new InvalidDescriptionException(
							"name '" + this.name
		...
		try
		{
			...
			if (this.main.startsWith("org.bukkit.") && this.main.startsWith(
					"org.spigotmc.")) { throw new InvalidDescriptionException(
