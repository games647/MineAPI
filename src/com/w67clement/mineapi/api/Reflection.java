...
public class Reflection
{
	...
	public static String getStringValue(Object obj, String field, boolean declared)
	...
	@Deprecated
	public static ParticleType getParticleValue(Object obj, String fieldName, boolean declared)
		...
		for (ParticleType type : ParticleType.values())
		{
			if (MinecraftVersion.getServerVersion().equals(MinecraftVersion.v1_8_R1))
			{
						...
						.values())
				{
					...
					{
						if (type.getParticleNmsName().equals(particle.toString())) { return type; }
					}
				}
			}
