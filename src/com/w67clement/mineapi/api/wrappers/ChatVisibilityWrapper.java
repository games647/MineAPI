	...
	public static MC_ChatVisibility makeMCChatVisibilityByEnumChatVisibility(Object chatVisibility)
	{
		if (MineAPI.getServerVersion().equals("v1_8_R3"))
		{
			return MC_ChatVisibility
					.valueOf(((net.minecraft.server.v1_8_R3.EntityHuman.EnumChatVisibility) chatVisibility).toString());
		}
		else if (MineAPI.getServerVersion().equals("v1_8_R2"))
		{
			return MC_ChatVisibility
					.valueOf(((net.minecraft.server.v1_8_R2.EntityHuman.EnumChatVisibility) chatVisibility).toString());
		}
		else if (MineAPI.getServerVersion().equals("v1_8_R1"))
		{
			return MC_ChatVisibility
					.valueOf(((net.minecraft.server.v1_8_R1.EnumChatVisibility) chatVisibility).toString());
		}
		else
		{
			return null;
