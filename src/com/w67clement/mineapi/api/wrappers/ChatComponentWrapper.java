...
import com.w67clement.mineapi.nms.v1_8_R1.wrappers.ChatComponentWrapper_v1_8_R1;
import com.w67clement.mineapi.nms.v1_8_R2.wrappers.ChatComponentWrapper_v1_8_R2;
import com.w67clement.mineapi.nms.v1_8_R3.wrappers.ChatComponentWrapper_v1_8_R3;
...
public class ChatComponentWrapper
{
	...
	public static String makeJsonByChatComponent(Object chatComponent)
	{
		if (MineAPI.getServerVersion().equals("v1_8_R3"))
		{
			return ChatComponentWrapper_v1_8_R3.makeJsonByChatComponent(chatComponent);
		}
		else if (MineAPI.getServerVersion().equals("v1_8_R2"))
		{
			return ChatComponentWrapper_v1_8_R2.makeJsonByChatComponent(chatComponent);
		}
		else if (MineAPI.getServerVersion().equals("v1_8_R1"))
		{
			return ChatComponentWrapper_v1_8_R1.makeJsonByChatComponent(chatComponent);
		}
		else
		{
			return null;
