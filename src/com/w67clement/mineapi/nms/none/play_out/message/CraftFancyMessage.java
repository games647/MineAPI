...
public class CraftFancyMessage implements FancyMessage
{

	private List<MessagePart> messageParts;

	public CraftFancyMessage(String string) {
		...
		Object packet = ReflectionAPI
				.newInstance(
						ReflectionAPI.getConstructor(
								ReflectionAPI.getNmsClass("PacketPlayOutChat"),
								ReflectionAPI.NmsClass
										.getIChatBaseComponentClass()),
				ChatComponentWrapper
						.makeChatComponentByJson(this.toJSONString()));
