...
public class PacketBlockChange_v1_8_R2 extends PacketBlockChange
{

	public PacketBlockChange_v1_8_R2(Material material, Location loc) {
		super(material, 0, loc);
	}

	public PacketBlockChange_v1_8_R2(Material material, int data, Location loc) {
		super(material, data, loc);
	}

	public PacketBlockChange_v1_8_R2(Material material, int x, int y, int z) {
		super(material, 0, x, y, z);
	}

	public PacketBlockChange_v1_8_R2(Material material, int data, int x, int y, int z) {
