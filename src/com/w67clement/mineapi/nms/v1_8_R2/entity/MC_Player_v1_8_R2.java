...
public class MC_Player_v1_8_R2 extends MC_EntityLiving_v1_8_R2 implements MC_Player
{
	...
	public void respawn()
	{
		if (getHandle().isDead()) new ClientCommand_v1_8_R2(ClientCommand.ClientCommandType.PERFORM_RESPAWN)
