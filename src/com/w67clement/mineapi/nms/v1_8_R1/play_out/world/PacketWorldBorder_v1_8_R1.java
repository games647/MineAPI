...
public class PacketWorldBorder_v1_8_R1 implements PacketWorldBorder
{
	...
	{
		PacketPlayOutWorldBorder worldBorder = new PacketPlayOutWorldBorder(((CraftWorld) this.world).getHandle().af(),
