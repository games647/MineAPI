 ...
 * 
 * @author w67clement
 * @version 2.0- CraftBukkit 1.8 SNAPSHOT
 */
public class PacketExplosion_v1_8_R1 extends PacketExplosion
{

	public PacketExplosion_v1_8_R1(World world, double x, double y, double z,
			float radius) {
