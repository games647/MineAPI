...
public class FancyMessage_v1_8_R1 implements FancyMessage
{

	private List<MessagePart> messageParts;

	public FancyMessage_v1_8_R1(String string) {
	...
	public void send(Player player)
	{
		((CraftPlayer) player).getHandle().playerConnection
				.sendPacket(new PacketPlayOutChat(ChatSerializer.a(this.toJSONString())));
	}
