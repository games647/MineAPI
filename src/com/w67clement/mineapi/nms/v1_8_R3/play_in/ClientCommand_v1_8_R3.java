package com.w67clement.mineapi.nms.v1_8_R3.play_in;
...
public class ClientCommand_v1_8_R3 implements ClientCommand
{
	...
	public void send(Player player)
	{
		...
		{
			packet = new PacketPlayInClientCommand(PacketPlayInClientCommand.EnumClientCommand.PERFORM_RESPAWN);
		}
		else if (this.commandType.equals(ClientCommand.ClientCommandType.REQUEST_STATS))
		{
			packet = new PacketPlayInClientCommand(PacketPlayInClientCommand.EnumClientCommand.REQUEST_STATS);
		}
