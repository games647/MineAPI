...
public class MC_EntityEnderman_v1_8_R3 extends MC_EntityCreature_v1_8_R3 implements MC_EntityEnderman
{
	...
	public ItemStack getCarriedBlock()
	{
		return CraftItemStack
				.asBukkitCopy(new net.minecraft.server.v1_8_R3.ItemStack(this.enderman.getCarried().getBlock()));
	}
