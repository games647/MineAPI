...
public class MC_Player_v1_8_R3 extends MC_EntityLiving_v1_8_R3 implements MC_Player
{
	...
	public void respawn()
	{
		if (getHandle().isDead()) new ClientCommand_v1_8_R3(ClientCommand.ClientCommandType.PERFORM_RESPAWN)
