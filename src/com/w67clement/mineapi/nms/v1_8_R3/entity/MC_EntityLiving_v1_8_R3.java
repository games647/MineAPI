...
public class MC_EntityLiving_v1_8_R3 extends MC_Entity_v1_8_R3 implements MC_EntityLiving
{

	private EntityLiving livingEntity;

	public MC_EntityLiving_v1_8_R3(LivingEntity entity) {
		super(entity);
	...
	public List<MC_Entity> getTargetEntities()
	{
		...
		{
			entities.add(new MC_Entity_v1_8_R3(entity.getBukkitEntity()));
		}
		return entities;
	}
