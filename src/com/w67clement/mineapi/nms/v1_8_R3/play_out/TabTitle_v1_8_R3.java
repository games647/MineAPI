package com.w67clement.mineapi.nms.v1_8_R3.play_out;
 ...
 * 
 * @author w67clement
 * @version 2.0 - CraftBukkit 1.8.4-1.8.8
 */
public class TabTitle_v1_8_R3 implements TabTitle
{
	...
	public void send(Player player)
	{
		...
		try
		{
			ReflectionAPI.setValue(tabTitlePacket, ReflectionAPI.getField(tabTitlePacket.getClass(), "b", true),
					tabFooter);
		}
		catch (Exception ex)
		{
