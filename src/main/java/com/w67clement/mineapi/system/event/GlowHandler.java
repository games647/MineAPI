...
public class GlowHandler implements IHandler
{
    ...
    public class GlowChannelInitializer extends ChannelInitializer<SocketChannel>
    {
        ...
        protected void initChannel(SocketChannel channel) throws Exception
        {
            ...
            channel.pipeline().addLast("encryption", NoopHandler.INSTANCE).addLast("framing", framing).addLast("compression", NoopHandler.INSTANCE).addLast("codecs", codecs).addLast("packet-interception", new GlowChannelHandler()).addLast("handler", handler);
        }
    ...
    public class GlowChannelHandler extends ChannelDuplexHandler
    {
        ...
        public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception
        {
            if (msg.getClass().getSimpleName().equals("HandshakeMessage") && MineAPI.hasEnableDebugConnection())
            {
            ...
            if ((!msg.getClass().getSimpleName().startsWith("Status")) || (!msg.getClass().getSimpleName().equals("HandshakeMessage")))
            {
                super.channelRead(ctx, msg);
                return;
            }
