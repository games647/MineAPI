...
public class ModuleLoader
{
    ...
    public Module loadModule(File file) throws InvalidModuleException
    {
        ...
        try
        {
            ...
            MineAPI.sendMessageToConsole(MineAPI.PREFIX + ChatColor.GREEN + "Loading " + ChatColor.DARK_GREEN + description.getName());
        }
    ...
    {
        MineAPI.sendMessageToConsole(MineAPI.PREFIX + ChatColor.GREEN + "Enabling " + ChatColor.DARK_GREEN + module.getName());
        module.onEnable();
    ...
    {
        MineAPI.sendMessageToConsole(MineAPI.PREFIX + ChatColor.GREEN + "Disabling " + ChatColor.DARK_GREEN + module.getName());
        module.onDisable();
