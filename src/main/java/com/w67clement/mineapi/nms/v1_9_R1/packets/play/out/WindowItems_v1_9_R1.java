 ...
 */
public class WindowItems_v1_9_R1 extends WindowItems<PacketPlayOutWindowItems>
{
    ...
    public WindowItems_v1_9_R1(PacketPlayOutWindowItems packetPlayOutWindowItems)
    {
    ...
    {
        net.minecraft.server.v1_9_R1.ItemStack[] nmsItems = getValueWithType(packet, itemsField, net.minecraft.server.v1_9_R1.ItemStack[].class);
        if (nmsItems == null)
            return null;
        ArrayList<ItemStack> items = new ArrayList<>();
        for (net.minecraft.server.v1_9_R1.ItemStack item : nmsItems)
        {
    ...
    {
        net.minecraft.server.v1_9_R1.ItemStack[] nmsItems = items.stream().map(CraftItemStack::asNMSCopy).collect(Collectors.toList()).toArray(new net.minecraft.server.v1_9_R1.ItemStack[items.size()]);
