 ...
 */
public class MC_Player_v1_9_R2 extends MC_EntityLiving_v1_9_R2 implements MC_Player
{

    private EntityPlayer player;

    public MC_Player_v1_9_R2(Player player)
    {
        super(player);
    ...
    {
        net.minecraft.server.v1_9_R2.EnumHand nmsHand;
        switch (hand)
        {
            case MAIN_HAND:
                nmsHand = net.minecraft.server.v1_9_R2.EnumHand.MAIN_HAND;
                break;
            case OFF_HAND:
                nmsHand = net.minecraft.server.v1_9_R2.EnumHand.OFF_HAND;
                break;
            default:
                nmsHand = net.minecraft.server.v1_9_R2.EnumHand.MAIN_HAND;
                break;
