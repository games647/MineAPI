 ...
 */
public class MC_EntityLiving_v1_9_R2 extends MC_Entity_v1_9_R2 implements MC_EntityLiving
{
    private net.minecraft.server.v1_9_R2.EntityLiving entityLiving;

    public MC_EntityLiving_v1_9_R2(LivingEntity entity)
    {
        super(entity);
    ...
    public List<MC_Entity> getTargetEntities()
    {
        ...
        return nmsEntities.stream().map(entity -> new MC_Entity_v1_9_R2(entity.getBukkitEntity())).collect(Collectors.toList());
    }
}
